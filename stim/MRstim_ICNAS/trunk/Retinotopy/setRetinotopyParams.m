...
expNames = {'Translating Bars 8 Pass (Dumoulin)', 'pRF bars simultaneous 3h/4v','rotating wedge (45deg duty)','rotating wedge (90deg duty)','rotating wedge (45deg duty) Reverse', ...
...
if ~isempty(params.calibration),
    ...
    params.display.dimensions = [87.8 48.5];
    params.display.pixelSize  = min(params.display.dimensions./params.display.numPixels);
    params.display.distance   = 50.5; %40; From MR measures file
...
case'pRF bars simultaneous 3h/4v',
    ...
    params.temporal.frequency = 20/params.temporal.motionSteps; %Hz
otherwise,
