function [T,NT] = getThreshold(respMatrix,numRepeats,nameFile)
...
PercentageCorrectanswers=(NumberCorrectanswer'*100)/numRepeats; % percentage of "yes" answers
...
trials_condition=numRepeats*ones(size(NumberCorrectanswer'));
