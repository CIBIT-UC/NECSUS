...
alignRun = strrep(fmrProjectNamePath,'_','-');
fmrProjectNamePath = char(fmrProjectNamePath);

%% open FmrProject
fmrProjectName = fullfile( configs.dataRootSubject, 'func', fmrProjectNamePath, 'PROJECT', 'PROCESSING', [ configs.filesSignature '_' alignRun '_bold.fmr']);
